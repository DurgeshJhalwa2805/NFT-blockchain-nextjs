...
const Home = ({ collections }: Props) => {
  return (
    <div className="mx-auto flex min-h-screen max-w-7xl flex-col py-20 px-10  2xl:px-0">
      ...
      <h1 className='mb-10 text-4xl font-extralight'>The {" "}<span className='font-extrabold underline decoration-pink-600/50 '>DJFAM</span>{" "}NFT Market Place</h1>
          ...
          (
            <Link href={`/nft/${collection.slug.current}`}>
              <div className='flex cursor-pointer flex-col items-center transition-all duration-200 hover:scale-105 ' >
                ...
                />
                <div className='p-5'>
                  <h2 className='text-3xl'>{collection.title}
                  </h2>
